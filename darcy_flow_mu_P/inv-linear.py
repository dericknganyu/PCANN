...
resultPATH = "pcalin-inv/"#"/localdata/Derick/stuart_data/Darcy_421/darcy_flow_mu_P/-inv-linear/"
#Read Datasets
...
for step_size in [2500]:#, 5000, 10000]:
    for gamma in [1e-2]:#1e-1, 1e-2, 1]:
        for wd in [1.5e-1]:#0, 1e-3, 1.5e-2, 1e-1, 1.5e-1]: #
            for batch_size in [200]:#100, 200, 500, 1000]:
                for learning_rate in [1e-3]:#, 2.5e-3, 1e-2]:
                    ...
                    U_PCANN = pcaY.inverse_transform(inPCANN).reshape(res, res)

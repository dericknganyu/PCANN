...
parser.add_argument('--dX', default=200, type = int, help='input reduced dimension')
parser.add_argument('--dY', default=200, type = int, help='output reduced dimension')
...
p_drop= 0.001
test_l2 = 0.098138
TIMESTAMP = '20220912-182453-934856'
...
fig.tight_layout()
plt.savefig(resultPATH+'figures/PCANN-Poisson-Inverse-UG.png',dpi=500)

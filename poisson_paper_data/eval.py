...
parser.add_argument('--ep', default=15000, type = int, help='epochs')#
...
resultPATH = "/localdata/Derick/stuart_data/Darcy_421/inv-poisson/"
#Read Datasets
...
for step_size in [5000]:#[2500, 5000, 10000]: #[5000]:#
    for gamma in [0.1]:#[1e-1, 1e-2, 1]: #[0.1]:#
        for wd in [0.1]:#[1.5e-2, 1e-1, 1.5e-1]: #[1.5e-2]:#
            for batch_size in [200]:#[100, 200, 500, 1000]: #[100]:#
                for learning_rate in [0.01]:#[1e-3, 2.5e-3, 1e-2]: #[2.5e-3]:#
                    torch.manual_seed(0)
                    np.random.seed(0)
